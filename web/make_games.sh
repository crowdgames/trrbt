...
python make_game.py ../games/ttt.yaml games/unxform ttt-text
python make_game.py ../games/connect4.yaml games/unxform connect4-text
python make_game.py ../games/checkers.yaml games/unxform checkers-text
python make_game.py ../games/checkers.yaml games/unxform checkers --sprites ../games/sprites/checkers/checkers.yaml
python make_game.py ../games/soko.yaml games/unxform soko-text
python make_game.py ../games/soko.yaml games/unxform soko --sprites ../games/sprites/soko/soko.yaml
python make_game.py ../games/blockdude.yaml games/unxform blockdude-text
python make_game.py ../games/blockdude.yaml games/unxform blockdude --sprites ../games/sprites/blockdude/blockdude.yaml
python make_game.py ../games/limerick.yaml games/unxform limerick-text
python make_game.py ../games/limerick.yaml games/unxform limerick --sprites ../games/sprites/limerick/limerick.yaml
python make_game.py ../games/choice.yaml games/unxform cyoa
python make_game.py ../games/lost_and_found.yaml games/unxform text-adventure
python make_game.py ../games/rust.yaml games/unxform rust-text
python make_game.py ../games/rust.yaml games/unxform rust --sprites ../games/sprites/dungeon/rust.yaml
